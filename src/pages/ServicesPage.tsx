...
export default function ServicesPage() {
  return <>
    ...
    <section className="cta-panel"><div className="shell cta-panel-inner"><SectionHeading eyebrow="OSÄKER PÅ VAD DU BEHÖVER?" eyebrowClassName="cta-eyebrow" title="Beskriv problemet så hjälper vi dig vidare." /><Link className="button button-light" to="/kontakt">Kontakta oss <ArrowRight size={18} /></Link></div></section>
  </>
}
